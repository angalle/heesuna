...
import com.sm.bookingtest.util.TabPagerAdapter;
...
public class MainActivity extends ActionBarActivity implements TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (String tab_name : tabs) {
			actionBar.addTab(actionBar.newTab().setText(tab_name).setTabListener(this).setIcon(getResources().getDrawable(R.drawable.mini_logo_gray)/*MainActivity.this.getResources(R.drawable.mini_logo_gray)*/));
		}
		/**
